...
<p align="center">
  ...
  <img src="screenshots/exercise\_demo.png" width="200"/>
</p>
...
|Layer|Technology|
|-|-|
|Frontend|Flutter (Dart), fl\_chart, confetti|
...
# Point DATABASE\_URL at your own Postgres (Neon, Supabase, or local):
export DATABASE\_URL="postgresql://user:password@host/dbname"
...
> Set the API base URL in `app/lib/services/api\_service.dart` to your backend
> (local or deployed).
